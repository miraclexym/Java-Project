...
public class ColorPanel extends JPanel {
    ...
    public static void chooseColor() {
        MyFrame.brushColor = JColorChooser.showDialog(null, "请选择颜色", MyFrame.brushColor);
        // 把左面板中的按钮颜色设置成选中按钮的背景颜色
        ColorPanel.bt.setBackground(MyFrame.brushColor);
        MyFrame.itemList[MyFrame.index].color = MyFrame.brushColor;
