...
public class MyFrame extends JFrame {
     ...
     * 初始状态是画笔
     */
    private static int currentTool = 3;
    ...
    private void init(String s) {
        ...
        drawingPanel.createNewGraphics();
    ...
    class DrawPanel extends JPanel {
        ...
        void undo() {
            index--;
            if (index >= 0) {
                if (currentTool == 3 || currentTool == 16 || currentTool == 17) {
        ...
        void createNewGraphics() {
            ...
            itemList[index].color = brushColor;
    ...
    class MyMenu {
        ...
        void addMenu() {
         ...
         // 给文件菜单设置监听
            ...
            // 给设置菜单添加监听
            setItemColor.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    // 设置颜色
            ...
            setItemUndo.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    // 撤销
                    drawingPanel.undo();
            ...
            strokeItems[0].addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    stroke = 1;
                    itemList[index].width = stroke;
            ...
            strokeItems[1].addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    stroke = 5;
                    itemList[index].width = stroke;
            ...
            strokeItems[2].addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    stroke = 15;
                    itemList[index].width = stroke;
            ...
            strokeItems[3].addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    stroke = 25;
                    itemList[index].width = stroke;
        ...
        void saveFile() {
            ...
            BufferedImage image = createImage(drawingPanel);
            try {
        ...
        void openFile() {
            ...
            try {
                ...
                itemList[index].board = drawingPanel;
                drawingPanel.repaint();
                index++;
                currentTool = 3;
                drawingPanel.createNewGraphics();
        ...
        void addToorbar() {
         ...
         // 将动作侦听器加入到按钮里面
            for (int i = 2; i < images.length; i++) {
                btnPaint[i].addActionListener(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
            ...
            btnPaint[0].addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    menu.saveFile();
                    saved = 1;
            ...
            btnPaint[1].addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    menu.newFile();
                }
            ...
            btnPaint[2].addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    drawingPanel.undo();
                }
            ...
            // 添加监听
            btnItalic.addItemListener(new ItemListener() {
                @Override
            ...
            btnBold.addItemListener(new ItemListener() {
                @Override
                public void itemStateChanged(ItemEvent e) {
                    blodtype = Font.BOLD;
                }
            ...
            jFontSize.addItemListener(new ItemListener() {
                @Override
                public void itemStateChanged(ItemEvent e) {
                    fSize = Integer.parseInt(fontSize[jFontSize.getSelectedIndex()]);
                }
            });
